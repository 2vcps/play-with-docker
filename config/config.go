...
func ParseFlags() {
	...
	flag.StringVar(&DefaultSessionDuration, "default-session-duration", "8h", "Default session duration if not specified otherwise")

	flag.StringVar(&PlaygroundDomain, "playground-domain", "pwddev.2vcps.io", "Domain to use for the playground")
